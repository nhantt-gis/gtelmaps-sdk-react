export type GlobalSettings = {
  ...
  /** The number of web workers instantiated on a page with gtelmaps-sdk maps.
   * @default 2
   */
  workerCount?: number;
  /** Provides an interface for loading gtelmaps-sdk's WebWorker bundle from a self-hosted URL.
