import type {GtelMapsProps} from '../gtelmaps/gtelmaps';
...
export function applyViewStateToTransform(
  /** An object that describes GTEL Maps's camera state */
  tr: TransformLike,
  ...
  if (
    ...
    // @ts-expect-error we should not import LngLat class from gtelmaps-sdk because we don't know the source of mapLib
